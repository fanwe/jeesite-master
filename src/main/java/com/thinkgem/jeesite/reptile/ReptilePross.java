package com.thinkgem.jeesite.reptile;
...
public class ReptilePross implements PageProcessor{
	...
	public static void main(String[] args) {
        ...
        Spider.create(new ReptilePross()).addUrl("https://www.cnblogs.com/").thread(5).run();
